...
package soc.gpio is
   ...
   subtype VALUE_PIN_Element is soc.bit;
   ...
   subtype INPUT_EN_PIN_Element is soc.bit;
   ...
   subtype OUTPUT_EN_PIN_Element is soc.bit;
   ...
   subtype PORT_PIN_Element is soc.bit;
   ...
   subtype PULLUP_PIN_Element is soc.bit;
   ...
   subtype DRIVE_PIN_Element is soc.bit;
   ...
   subtype RISE_INT_EN_PIN_Element is soc.bit;
   ...
   --  RISE_INT_PEND_PIN array element
   subtype RISE_INT_PEND_PIN_Element is soc.bit;

   --  RISE_INT_PEND_PIN array
   type RISE_INT_PEND_PIN_Field_Array is array (0 .. 31)
     of RISE_INT_PEND_PIN_Element
     with Component_Size => 1, Size => 32;
   ...
   subtype FALL_INT_EN_PIN_Element is soc.bit;
   ...
   subtype FALL_INT_PEND_PIN_Element is soc.bit;
   ...
   subtype HIGH_INT_EN_PIN_Element is soc.bit;
   ...
   subtype HIGH_INT_PEND_PIN_Element is soc.bit;
   ...
   subtype LOW_INT_EN_PIN_Element is soc.bit;
   ...
   subtype LOW_INT_PEND_PIN_Element is soc.bit;
   ...
   subtype IO_FUNC_EN_PIN_Element is soc.bit;
   ...
   subtype IO_FUNC_SEL_PIN_Element is soc.bit;
   ...
   subtype OUT_XOR_PIN_Element is soc.bit;
