...
package soc.pmu is
   ...
   subtype WAKEUPI_DELAY_Field is soc.bits_4;
   subtype WAKEUPI_PMU_OUT_0_Field is soc.bit;
   subtype WAKEUPI_PMU_OUT_1_Field is soc.bit;
   subtype WAKEUPI_CORERST_Field is soc.bit;
   subtype WAKEUPI_HFCLKRST_Field is soc.bit;
   ...
   subtype SLEEPI_DELAY_Field is soc.bits_4;
   subtype SLEEPI_PMU_OUT_0_Field is soc.bit;
   subtype SLEEPI_PMU_OUT_1_Field is soc.bit;
   subtype SLEEPI_CORERST_Field is soc.bit;
   subtype SLEEPI_HFCLKRST_Field is soc.bit;
   ...
   subtype IE_RTC_Field is soc.bit;
   subtype IE_DWAKEUP_Field is soc.bit;

   --  PMU interrupt enables.
   type IE_Register is record
      --  unspecified
      Reserved_0_0  : soc.bit := 16#0#;
      RTC           : IE_RTC_Field := 16#0#;
      DWAKEUP       : IE_DWAKEUP_Field := 16#0#;
      --  unspecified
      Reserved_3_31 : soc.bits_29 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          bit_Order => System.Low_Order_First;
   ...
   type CAUSE_Register is record
      WAKEUP_CAUSE   : CAUSE_Wakeup_Cause_Values := soc.PMU.Reset;
      --  unspecified
      Reserved_2_7   : soc.bits_6 := 16#0#;
      RESET_CAUSE    : CAUSE_Reset_Cause_Values :=
                        Cause_Reset_Cause_Values_Reset;
      --  unspecified
      Reserved_10_31 : soc.bits_22 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          bit_Order => System.Low_Order_First;
