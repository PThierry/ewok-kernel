...
package soc.otp_mem is
   ...
   subtype HFROSC_TRIM_VALUE_Field is soc.bits_5;
   ...
   --  Code to jump to SPI-FLASH.
   type LAST_FENCE_Registers is array (0 .. 2) of soc.unsigned_32;
