...
package soc.plic is
   ...
   subtype PRIORITY_PRIORITY_Field is soc.bits_3;
   ...
   --  PENDING_INT array element
   subtype PENDING_INT_Element is soc.bit;

   --  PENDING_INT array
   type PENDING_INT_Field_Array is array (0 .. 31) of PENDING_INT_Element
   ...
   --  ENABLE_TARGET_ENABLE_INT array element
   subtype ENABLE_TARGET_ENABLE_INT_Element is soc.bit;

   --  ENABLE_TARGET_ENABLE_INT array
   type ENABLE_TARGET_ENABLE_INT_Field_Array is array (0 .. 31)
     of ENABLE_TARGET_ENABLE_INT_Element
     with Component_Size => 1, Size => 32;
   ...
   subtype THRESHOLD_TARGET_THRESHOLD_Field is soc.bits_3;
   ...
   is record
      ...
      case Discriminent is
         when Laim =>
            --  PLIC Claim Register.
            CLAIM : aliased soc.unsigned_32;
         when Omplete =>
            --  PLIC Complete Register.
            COMPLETE : aliased soc.unsigned_32;
      end case;
   end record
